...
-(void)initLaiDianView:(NSDictionary *)info
{
    ...
    UIButton * jieShouButton = [[UIButton alloc] initWithFrame:CGRectMake(492*BILI/2, 7*BILI, 36*BILI, 36*BILI)];
    ...
    UIButton * jvJueButton = [[UIButton alloc] initWithFrame:CGRectMake(300*BILI, 7*BILI, 36*BILI, 36*BILI)];
		...
		if (![self isDisplayingPageForIndex:index]) {
            ...
            if (page.displayingVideo) {
               ...
               // [playButton setImage:[UIImage imageForResourcePath:@"MWPhotoBrowser.bundle/PlayButtonOverlayLarge" ofType:@"png" inBundle:[NSBundle bundleForClass:[self class]]] forState:UIControlStateNormal];
                [playButton setImage:[UIImage imageNamed:@"bofang copy"] forState:UIControlStateNormal];
