...
@implementation TanLiaoLiao_TrendsDianZanOrDaShangTableViewCell
...
-(void)initData:(NSDictionary *)info
{
    ...
    {
        UIImageView * ibpwmbU61360 = [[UIImageView alloc]initWithFrame:CGRectMake(40,69,80,48)];
        ibpwmbU61360.layer.cornerRadius =9;
        ibpwmbU61360.userInteractionEnabled = YES;
        ibpwmbU61360.layer.masksToBounds = YES;
        [self addSubview:ibpwmbU61360];
    }
 

    
}
- (void)gsc_yuuakkS87314xyhxV705
{
    UIScrollView * CnouaQwhoi = [[UIScrollView alloc]initWithFrame:CGRectMake(59,75,70,61)];
    CnouaQwhoi.layer.cornerRadius =6;
    [self addSubview:CnouaQwhoi];
