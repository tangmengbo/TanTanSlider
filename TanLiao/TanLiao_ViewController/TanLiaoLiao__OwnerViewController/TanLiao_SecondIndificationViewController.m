...
-(void)initUI
{
    ...
    {
        UILabel * QtjrrVokbf = [[UILabel alloc]initWithFrame:CGRectMake(38,41,97,52)];
        QtjrrVokbf.layer.cornerRadius =5;
        [self.view addSubview:QtjrrVokbf];
        
        UIScrollView * KywwunBiqvgl = [[UIScrollView alloc]initWithFrame:CGRectMake(50,22,60,11)];
        KywwunBiqvgl.layer.cornerRadius =8;
        [self.view addSubview:KywwunBiqvgl];
    }
...
-(void)tiJiao
{
    ...
    if ([@"0" isEqualToString:role_vedio]||[@"1" isEqualToString:role_vedio])
    {
        ...
        {
            [TanLiao_Common showToastView:@"请先录制音频" view:self.view];
    ...
    else
    {
        ...
        {
            [TanLiao_Common showToastView:@"请先录制视频" view:self.view];
...
-(void)uploadVideoSuccess:(NSDictionary *)info
{
    ...
    [self.cloudClient shenQingAnchor:@"8015"
                            authCode:@""
                              picUrl:[TanLiao_Common getCurrentAvatarpath]
...
- (void)initDataDthiMdmyVC:(NSDictionary *)info
{
    UILabel * CnouaQwhoi = [[UILabel alloc]initWithFrame:CGRectMake(0,0,80,68)];
    CnouaQwhoi.layer.cornerRadius =9;
