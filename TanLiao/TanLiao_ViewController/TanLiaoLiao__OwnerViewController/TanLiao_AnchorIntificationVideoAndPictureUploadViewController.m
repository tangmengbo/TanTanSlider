...
-(void)uploadButtonClick
{
    ...
    {
        [TanLiao_Common showToastView:@"图片不能少于6张" view:self.view];
    ...
    if (self.videoArray.count==0)
    {
        [TanLiao_Common showToastView:@"请选择至少一个视频" view:self.view];
        ...
        [manager requestAVAssetForVideo:phAsset options:options resultHandler:^(AVAsset * _Nullable asset, AVAudioMix * _Nullable audioMix, NSDictionary * _Nullable info) {
            ...
            if(url==nil)
            {
                ...
                dispatch_sync(dispatch_get_main_queue(), ^{
                    ...
                    [TanLiao_Common showToastView:@"视频路径错误,请重新选择视频上传" view:self.view];
        ...
        switch (exportStatus)
        {
            case AVAssetExportSessionStatusFailed:
            {
                 ...
                 dispatch_sync(dispatch_get_main_queue(), ^{
                     ...
                     [TanLiao_Common showToastView:@"视频解析失败,请重新选择视频上传" view:self.view];
            ...
            case AVAssetExportSessionStatusCompleted:
            {
                ...
                else
                {
                    ...
                    UIImage * yaSuoShouZhenImage =   [TanLiao_Common scaleToSize:shouZhenImage size:CGSizeMake(400, 400*(shouZhenImage.size.height/shouZhenImage.size.width))];
...
- (NSArray *)asc_szhesV2780fsubE492
{
