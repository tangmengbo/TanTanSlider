...
-(void)getSourceListSuccess:(NSDictionary *)info
{
    ...
    [self.cloudClient getAnchorDetailMes:[Common getNowUserID]
...
if (![@"FQSQStatus" isEqualToString:FQSQSHSTATUS])
{
    ...
    UIImageView * gfmyvL5416 = [[UIImageView alloc]initWithFrame:CGRectMake(29,87,1,66)];
    gfmyvL5416.layer.cornerRadius =5;
    gfmyvL5416.userInteractionEnabled = YES;
    gfmyvL5416.layer.masksToBounds = YES;
    
    UITextView * afaobG7411 = [[UITextView alloc]initWithFrame:CGRectMake(15,33,63,94)];
    afaobG7411.layer.cornerRadius =7;
    afaobG7411.userInteractionEnabled = YES;
    afaobG7411.layer.masksToBounds = YES;
    
    UIScrollView * hfscS328 = [[UIScrollView alloc]initWithFrame:CGRectMake(4,48,100,38)];
    hfscS328.layer.borderWidth = 1;
    hfscS328.clipsToBounds = YES;
    hfscS328.layer.cornerRadius =8;

  UITableView * txvipG4624 = [[UITableView alloc]initWithFrame:CGRectMake(3,14,0,63)];
  txvipG4624.layer.borderWidth = 1;
  txvipG4624.clipsToBounds = YES;
  txvipG4624.layer.cornerRadius =5;
}
...
-(void)tuiJianButtonClick
{
    if (self.mySourceArray.count<3) {
        ...
        [Common showToastView:@"互动问题不能少于3个哦~" view:self.view];
...
-(void)setSuccess:(NSDictionary *)info
{
    ...
    [Common showToastView:@"互动问题设置成功" view:self.view];
