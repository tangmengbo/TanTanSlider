...
@implementation ChatCallVideoMessageCell
+ (CGSize)sizeForMessageModel:(RCMessageModel *)model
      withCollectionViewWidth:(CGFloat)collectionViewWidth
         referenceExtraHeight:(CGFloat)extraHeight {
    ChatCallVideoMessage *message = (ChatCallVideoMessage *)model.content;
    CGSize size = [ChatCallVideoMessageCell getBubbleBackgroundViewSize:message];
...
- (void)setAutoLayout {
    ChatCallVideoMessage *testMessage = (ChatCallVideoMessage *)self.model.content;
    if (testMessage) {
    ...
    imageView.image = [UIImage imageNamed:@"pic_video_chat"];
    ...
    bottomView.backgroundColor = UIColorFromRGB(0x4990E2);
...
+ (CGSize)getTextLabelSize:(ChatCallVideoMessage *)message {
