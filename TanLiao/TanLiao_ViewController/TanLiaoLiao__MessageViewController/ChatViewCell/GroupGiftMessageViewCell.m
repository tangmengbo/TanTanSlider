...
@implementation GroupGiftMessageViewCell
+ (CGSize)sizeForMessageModel:(RCMessageModel *)model
      withCollectionViewWidth:(CGFloat)collectionViewWidth
         referenceExtraHeight:(CGFloat)extraHeight {
    ChatGroupGiftMsgMessage *message = (ChatGroupGiftMsgMessage *)model.content;
    CGSize size = [GroupGiftMessageViewCell getBubbleBackgroundViewSize:message];
...
- (void)setAutoLayout {
    ChatGroupGiftMsgMessage *testMessage = (ChatGroupGiftMsgMessage *)self.model.content;
    if (testMessage) {
...
+ (CGSize)getTextLabelSize:(ChatGroupGiftMsgMessage *)message {
