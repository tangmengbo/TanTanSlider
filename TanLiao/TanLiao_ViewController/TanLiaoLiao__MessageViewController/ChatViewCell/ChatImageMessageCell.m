...
+ (CGSize)sizeForMessageModel:(RCMessageModel *)model
    ...
    FQSQ_ChatImageMessage *message = (FQSQ_ChatImageMessage *)model.content;
    CGSize size = [ChatImageMessageCell getBubbleBackgroundViewSize:message];
...
- (void)setAutoLayout {
    FQSQ_ChatImageMessage *testMessage = (FQSQ_ChatImageMessage *)self.model.content;
    if (testMessage) {
    ...
    boFangImageView.image = [UIImage imageNamed:@"pic_messages_lock_72"];
    ...
    bottomView.backgroundColor = UIColorFromRGB(0xBAA6FB);
...
+ (CGSize)getTextLabelSize:(FQSQ_ChatImageMessage *)message {
