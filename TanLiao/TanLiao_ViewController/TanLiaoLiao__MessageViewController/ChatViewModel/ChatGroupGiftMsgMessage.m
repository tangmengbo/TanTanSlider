...
@implementation ChatGroupGiftMsgMessage
///初始化
+ (instancetype)messageWithContent:(NSString *)content {
    ChatGroupGiftMsgMessage *text = [[ChatGroupGiftMsgMessage alloc] init];
    if (text) {
...
+ (RCMessagePersistent)persistentFlag {
    ...
    return MessagePersistent_NONE;//不发送本地通知
}
...
+ (NSString *)getObjectName {
    return RCDGroupGiftTypeIdentifier;
}
@end
