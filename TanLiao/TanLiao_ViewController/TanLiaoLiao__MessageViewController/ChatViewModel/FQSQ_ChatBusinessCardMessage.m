...
@implementation FQSQ_ChatBusinessCardMessage
///初始化
+ (instancetype)messageWithContent:(NSString *)content {
    FQSQ_ChatBusinessCardMessage *text = [[FQSQ_ChatBusinessCardMessage alloc] init];
    if (text) {
...
+ (NSString *)getObjectName {
    return RCDBusinessCardTypeIdentifier;
}
@end
