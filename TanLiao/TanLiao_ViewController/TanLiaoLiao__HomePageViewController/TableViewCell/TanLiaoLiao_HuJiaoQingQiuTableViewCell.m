...
#import "TanLiaoLiao_HuJiaoQingQiuTableViewCell.h"

@implementation TanLiaoLiao_HuJiaoQingQiuTableViewCell
...
-(void)initData:(NSDictionary *)info
{
    ...
    if(info!=nil)
    {
        ...
        CGSize nameSize = [TanLiao_Common setSize:[TanLiao_Common getCurrentUserName] withCGSize:CGSizeMake(VIEW_WIDTH, VIEW_WIDTH) withFontSize:19*BILI];
...
{
    [self.delegate jieTingHuJiao:self.info];
}
