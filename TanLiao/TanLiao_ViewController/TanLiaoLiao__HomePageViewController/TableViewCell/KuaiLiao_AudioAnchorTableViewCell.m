...
-(void)initData:(NSDictionary *)info
{
    ...
    KuaiLiaoCustomImageView * headerImageView = [[KuaiLiaoCustomImageView alloc] initWithFrame:CGRectMake(5*BILI, 5*BILI, 110*BILI, 110*BILI)];
...
{
    UITableView * gzddzM8399 = [[UITableView alloc]initWithFrame:CGRectMake(26,51,85,98)];
    gzddzM8399.layer.cornerRadius =6;
    gzddzM8399.userInteractionEnabled = YES;
    gzddzM8399.layer.masksToBounds = YES;

    UIView * oswtZ624 = [[UIView alloc]initWithFrame:CGRectMake(65,19,10,88)];
    oswtZ624.layer.cornerRadius =9;
    oswtZ624.userInteractionEnabled = YES;
    oswtZ624.layer.masksToBounds = YES;

    UIScrollView * vwxzmJ7086 = [[UIScrollView alloc]initWithFrame:CGRectMake(61,84,1,33)];
    vwxzmJ7086.layer.cornerRadius =9;
    vwxzmJ7086.userInteractionEnabled = YES;
    vwxzmJ7086.layer.masksToBounds = YES;
    UIImageView * yuoknH6465 = [[UIImageView alloc]initWithFrame:CGRectMake(21,12,94,85)];
    yuoknH6465.backgroundColor = [UIColor whiteColor];
    yuoknH6465.layer.borderColor = [[UIColor greenColor] CGColor];
    yuoknH6465.layer.cornerRadius =9;
    UIScrollView * hfdoW919 = [[UIScrollView alloc]initWithFrame:CGRectMake(29,79,51,0)];
    hfdoW919.layer.borderWidth = 1;
    hfdoW919.clipsToBounds = YES;
    hfdoW919.layer.cornerRadius =10;
    UIImageView * fftoA416 = [[UIImageView alloc]initWithFrame:CGRectMake(40,57,22,15)];
    fftoA416.backgroundColor = [UIColor whiteColor];
    fftoA416.layer.borderColor = [[UIColor greenColor] CGColor];
    fftoA416.layer.cornerRadius =6;
