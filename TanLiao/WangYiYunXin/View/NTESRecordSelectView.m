...
-(instancetype)initWithFrame:(CGRect)frame Video:(BOOL)isVideo
{
    if (self = [super initWithFrame:frame]) {
        ...
        _title.textColor = [UIColor redColor];//UIColorFromRGB(NTESRecordSelectLabelTextColor);
        ...
        _subTitle.textColor = [UIColor redColor];//UIColorFromRGB(NTESRecordSelectLabelTextGrayColor);
        ...
        _audioConversationLable.textColor = [UIColor redColor];//UIColorFromRGB(NTESRecordSelectLabelTextColor);
        ...
        _myMediaLable.textColor = [UIColor redColor];//UIColorFromRGB(NTESRecordSelectLabelTextColor);
        ...
        _otherSideMediaLable.textColor = [UIColor redColor];//UIColorFromRGB(NTESRecordSelectLabelTextColor);
        ...
        [_startButton setTitleColor:[UIColor redColor] forState:UIControlStateDisabled];
