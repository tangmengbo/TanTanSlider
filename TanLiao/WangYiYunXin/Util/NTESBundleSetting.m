...
{
    NSInteger videoQualitySetting = 3;     //[[[NSUserDefaults standardUserDefaults]   objectForKey:@"videochat_preferred_video_quality"] integerValue];
    ...
    return NIMNetCallVideoQualityHigh;
}
